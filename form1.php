...
<form action="form1.php" method="post"> 
    <table>
            ...
            <tr>
                <th>プルダウン</th>
                    <td>  <select name="subject">  
                        <option value="プルダウン①" <?php if(isset($subject) && $subject === "プルダウン①") { echo "selected" ;} ?>>プルダウン①
                        </option> 
                        <option value="プルダウン②" <?php if(isset($subject) && $subject === "プルダウン②") {echo "selected"; } ?>>プルダウン②
                        </option>  
                        </select>
        ...
        　　</tr> 
        <tr>
            <td colspan="2"><input type="submit" name="submit" value="確認画面へ"></td> </tr> </table> 
        </form>
    </body> 
</html>
